...
public class studentHostel_19BCE2101 {
public static void main(String[] args) throws FileNotFoundException, IOException,ClassNotFoundException{
List<Student1> sList = new ArrayList<Student1>();
Scanner sc=new Scanner(System.in);
System.out.println("Enter number of students:");
int n=sc.nextInt();
System.out.println("Enter details of Student as\n RegNO Name CGPA Preferred_Room");
for(int i=0;i<n;i++)
{
System.out.println("For Student "+(i+1)+":");
sList.add(new Student1(sc.next(),sc.next(),sc.nextFloat(),sc.nextInt()));
}
FileOutputStream Fout = new FileOutputStream("C:\\Users\\Gurtavrein Singh\\Documents\\NetBeansProjects\\studHostel.txt");
ObjectOutputStream out = new ObjectOutputStream(Fout);
out.writeObject(sList);
out.close();
System.out.println("***Inserted in File***");
FileInputStream fin = new FileInputStream("C:\\Users\\Gurtavrein Singh\\Documents\\NetBeansProjects\\studHostel.txt");
ObjectInputStream in = new ObjectInputStream(fin);
ArrayList<Student1> nList = new ArrayList<Student1>();
...
in.close();
Student1[] sortedcgpa = nList.toArray(new Student1[nList.size()]);
...
synchronized int book(Student1[] sortedcgpa) throws InterruptedException {
for (Student1 sortedcgpa1 : sortedcgpa) {
...
hostel b1;
Student1[] sortedcgpa = new Student1[5];
Warden(hostel b1, Student1[] sortedcgpa) {
this.b1 = b1;
